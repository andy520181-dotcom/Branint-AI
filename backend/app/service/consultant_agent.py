...
# ── 智能路由 Prompt ────────────────────────────────────────────────────────
ROUTING_SYSTEM_PROMPT = """你是 Branint AI 的首席品牌顾问，负责根据客户需求灵活调度专业智能体。
...
# ── 质量审核 & 最终报告 Prompt ────────────────────────────────────────────
QUALITY_REVIEW_SYSTEM_PROMPT = """你是 Branint AI 的首席品牌顾问，拥有 15 年以上顶级品牌咨询经验。
